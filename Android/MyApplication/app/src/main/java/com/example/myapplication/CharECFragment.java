...
public class CharECFragment extends Fragment {
    ...
    public static CharECFragment newInstance(String param1, String param2) {
        CharECFragment fragment = new CharECFragment();
